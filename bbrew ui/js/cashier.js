document.addEventListener('DOMContentLoaded', function() {
    ...
    // Set initial page state to Counter
    initializePageState();
    
    // Function to initialize the page state
    function initializePageState() {
        // Set Counter nav item as active
        document.querySelector('.nav-item[data-page="counter"]').classList.add('active');
        
        // Show category tabs
        categoryTabs.style.display = 'flex';
        
        // Show milktea menu content
    ...
    function addCategoryToUI(categoryName) {
        ...
        // Assign a color from predefined colors
    ...
    // Function to download order details as PDF
