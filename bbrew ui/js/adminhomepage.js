document.addEventListener('DOMContentLoaded', function() {
    ...
    let salesChart = null;
    let currentManageOrderFilter = 'pending';
    ...
    function showOrderDetails(order) {
        ...
        if (order.status === 'Pending') {
            panelFooter.innerHTML = `
                <button class="mark-done-btn" id="acceptOrderBtn">Accept Order</button>
            `;
            document.getElementById('acceptOrderBtn').addEventListener('click', function() {
                acceptOrder(order.orderNumber);
            });
    ...
    // Event listeners for filter buttons in Manage Orders
